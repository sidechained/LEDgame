...
void Audio_DAC_Init(int sample_rate, size_t block_size) {
  instance_ = this;
...
void Audio_DAC_Start(FillBufferCallback callback) {
  callback_ = callback;
  DMA_Cmd(DMA1_Stream7, ENABLE); /* Enable the I2S DMA Stream*/
}

void Audio_DAC_Fill(size_t offset) {
  (*callback_)(&tx_dma_buffer_[offset * block_size_], block_size_);
}

void Audio_DAC_Codec_GPIO_Init(void)
{
...
void Audio_DAC_Codec_Reset(void)
{
...
void Audio_DAC_Codec_CtrlInterface_Init(void)
{
...
void Audio_DAC_Codec_Configure(void)
{
...
void Audio_DAC_Codec_WriteRegister(uint8_t RegisterAddr, uint8_t RegisterValue)
{
...
void Audio_DAC_Codec_AudioInterface_Init(int sample_rate)
{
...
void Audio_DAC_DMA1_Stream7_IRQ_Init(void)
{
...
void Audio_DAC_DirectMemoryAccess_Init(size_t block_size)
{
...
void Audio_DAC_Codec_TIMEOUT_UserCallback(void)// Basic management of the timeout situation.
{
  while (1) { }
}

void Audio_DAC_DMA1_Stream7_IRQHandler(void)
{
